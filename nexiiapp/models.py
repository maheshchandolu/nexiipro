...
class Requirement(AbstractBaseClass):
    ...
    score= models.DecimalField(decimal_places=2, max_digits=100, default=0) # To store the credit score for posted requirement 
...
class Upload(AbstractBaseClass):
    ...
    score= models.DecimalField(decimal_places=2, max_digits=100, default=0) # Store the credit score of the uploaded files
    actor= models.ForeignKey(
        User,
        on_delete=models.CASCADE,
...
class UserCredit(AbstractBaseClass):
    ...
    upload_credit= models.DecimalField(decimal_places=2, max_digits=100, default=0)
    download_credit= models.DecimalField(decimal_places=2, max_digits=100, default=0)
    available_credit= models.DecimalField(decimal_places=2, max_digits=100, default=0)
...
class TransactionHistory(AbstractBaseClass):
    ...
    requirement_id= models.ForeignKey(
    	...
    	null=True
    	)# used for store the id of requirement
    amount= models.DecimalField(decimal_places=2, max_digits=100, default=0)# to store debit and credit scores
